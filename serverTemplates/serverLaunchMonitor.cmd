...
:: SERVER MONITOR LOOP DURATION (DEFAULT 10 SECONDS)
set servermonitorduration=10
:: SERVER RESTART TIME EACH DAY (HHMM ONE OR MULTIPLE RESTART TIMES, SPACE SEPARATED)
set serverrestarttimes=0600 1800
...
title %servername% MONITOR (%serverip% %serverport%)
...
:serverexit
echo --------------------------------------------------
echo  + %servername% - SERVER ALREADY RUNNING, EXITING
echo --------------------------------------------------
pause
exit /b
